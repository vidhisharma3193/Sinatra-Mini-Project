...
o7 = Option.create(value: "1", poll_id: p2.id)
o8 = Option.create(value: "2", poll_id: p2.id)
o9 = Option.create(value: "3", poll_id: p2.id)
o10 = Option.create(value: "4", poll_id: p2.id)
o11 = Option.create(value: "5", poll_id: p2.id)
o12 = Option.create(value: "6", poll_id: p2.id)
o13 = Option.create(value: "7", poll_id: p2.id)
o14 = Option.create(value: "8", poll_id: p2.id)
o15 = Option.create(value: "9", poll_id: p2.id)
o16 = Option.create(value: "10", poll_id: p2.id)

o17 = Option.create(value: "Ruby", poll_id: p2.id)
o18 = Option.create(value: "JavaScript", poll_id: p2.id)
o19 = Option.create(value: "Java", poll_id: p2.id)
o20 = Option.create(value: "C++", poll_id: p2.id)
o21 = Option.create(value: "Other", poll_id: p2.id)
